...
\node[anchor=south,xshift=15pt,yshift=20pt,rotate=-62,orange!85!black](BeNineLabel)
...
\node[anchor=south,xshift=30pt,yshift=-15pt,rotate=-62,red](BElevenLine) at (axis cs:2.34,{\Lscale*\mArealPBEleven/2.34}) {\,Solid $^{11}$B};

\draw[thick,->,red]
  (BElevenLine) -- (BElevenDot);
...
\node[anchor=south,xshift=10pt,rotate=-62,blue](LiLine) at (axis cs:0.53,{\Lscale*\mArealPLiSeven/0.53}) {\,Solid $^{6/7}$Li};
...
\node[anchor=south east,rotate=-62,violet]
  at (axis cs:0.17,{\Lscale*\mArealDD/0.17})
  {\,Liq.\ D$_2$};
...
\node[anchor=north east,rotate=-62,violet]
  at (axis cs:0.82,{\Lscale*\mArealDD/(\wLiD*0.82)})
  {\,Solid LiD};
...
\node[anchor=south west,rotate=-62,violet]
  at (axis cs:1.105,{\Lscale*\mArealDD/(\wDtwoO*1.105)})
  {\,Liq.\ D$_2$O};
