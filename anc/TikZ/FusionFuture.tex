...
\node[font=\small,rotate=20,anchor=north west,text=black!70] at (axis cs:2005,2005) {Forbidden};
\node[font=\small,rotate=20,anchor=south west,text=black!70] at (axis cs:1985,{1985+60}) {Shot-in-the-dark};

\legend{Demonstration,Commercial}

%\node[font=\scriptsize, anchor=north east] at (axis description cs:1.0,1.0) {\textcopyright\ 2025 Steinmetz \& Rafelski. \href{https://creativecommons.org/licenses/by/4.0/}{CC~BY~4.0}};
