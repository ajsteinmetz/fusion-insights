...
% Plots and legend entries are both ordered by decreasing m_areal, i.e. in the
% order the curves appear from top to bottom:
%   p+11B(narrow) 184.5, p+7Li 129.2, p+6Li 45.3, d+6Li 22.6, d+7Li 19.4,
%   p+9Be 18.0, d+d 17.5, p+11B(broad) 15.0, d+3He 6.1, t+d 0.66  [g/cm^2]

% Phantom entry heading the legend: no line, only the reading rule for the
% labels below it.  Must precede the first \addplot to take the first slot.
\addlegendimage{draw=none,no markers}
...
\addlegendentry{\hspace{-0.62cm}\textbf{beam} $+$ \textbf{target} (peak $E_{\rm cm}$)}
