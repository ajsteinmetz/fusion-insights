...
\node[anchor=north west,rotate=-62,red](BElevenLine) at (axis cs:2.34,{\Lscale*\mArealPBEleven/2.34}) {\,Solid $^{11}$B};
...
% No text label here: it lands on the violet 'Liq. D_2O' label. The dot sits
% directly above the labelled 'Solid 11B' dot on the broad-resonance curve.
